...
class GitRepositoriesPage extends StatefulWidget {
  ...
  const GitRepositoriesPage({Key? key, required this.login, required this.avatarUrl}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Center(
        child: ListView.separated(
            ...
            separatorBuilder:(context, index) => Divider(height: 2, color: Theme.of(context).primaryColor,),
